...
VAR_LABELS_EN <- c(
  ...
  "Pensión Contributiva Media"                                          = "Mean pension",
  # En VAR_LABELS_EN, añade AMBAS versiones:
  ...
  "Consultorio de atención primaria (número)"                           = "Primary care centres",
  "Oficina de farmacia (número)"                                        = "Pharmacies",
  "Nº centros de Educación Primaria"                                    = "Primary schools",
  "No centros de Educación Primaria"                                    = "Primary schools",
  "Tiempo municipio 5.000 hab. o más, más cercano (minutos)"           = "Time to 5k-inhab. town (min)",
  "Tiempo municipio 20.000 hab. o más, más cercano (minutos)"          = "Time to 20k-inhab. town (min)",
  "Sucursal bancaria (número)"                                          = "Bank branches",
  ...
  "Densidad (hab/km2)"                                                  = "Population density",
